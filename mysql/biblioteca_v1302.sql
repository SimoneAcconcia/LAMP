...
SELECT distinct Nome from Autori WHERE Nazionalita ='Americano';

-- Trova tutti i libri disponibili nel magazzino e pubblicati dopo il 2000:
SELECT distinct Titolo from Libri WHERE AnnoPubblicazione>200;

-- Identifica i prestiti che sono scaduti, usa la funzione curdate() per ottenere la data corrente:
SELECT * from Prestiti WHERE DataScadenza<curdate();
...
-- Prossimi 5 libri dopo i primi 5, ordinati per anno di pubblicazione:
